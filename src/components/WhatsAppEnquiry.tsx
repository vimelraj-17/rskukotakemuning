...
export function WhatsAppEnquiry({ phoneNumber, enquiry }: WhatsAppEnquiryProps) {
  ...
  return <div className="whatsapp-enquiry">
    <div><p className="eyebrow eyebrow--light">Final step</p><h3>Confirm this selection on WhatsApp.</h3><p>No personal information is collected or stored by this website.</p></div>
