...
export function SelectionSummary({ projectName, layout, packageDefinition: pkg, unit, onEditLayout, onEditPackage, onEditUnit, onCopy, copyStatus, phoneNumber, configurationUrl }: SelectionSummaryProps) {
